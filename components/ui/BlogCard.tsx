  ...
  return (
    <Link href={`/blog/${post.slug}`} className="block h-full">
      <GlassCard className="h-full flex flex-col group">
        <div className="relative w-full aspect-[16/9] mb-4 rounded-lg overflow-hidden bg-tint">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          {showDate && <span className="text-xs text-subtle">{post.date}</span>}
        </div>
        <h3 className="font-heading text-lg font-bold text-heading mb-2 group-hover:text-primary transition-colors line-clamp-2">
          {post.title}
        </h3>
