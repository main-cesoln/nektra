        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <p className="text-xs text-subtle font-mono mb-4">{COMPANY.tagline}</p>
              {COMPANY.socials && (
            ...
            {/* Quick Links */}
            <div>
              <h3 className="font-heading text-heading font-semibold mb-4">Quick Links</h3>
            ...
            {/* Products */}
            <div>
              <h3 className="font-heading text-heading font-semibold mb-4">Products</h3>
              <ul className="space-y-2">
                {PRODUCTS.map((p) => (
                  <li key={p.slug}>
                    <Link
            ...
            {/* Contact */}
            <div>
              <h3 className="font-heading text-heading font-semibold mb-4">Contact Us</h3>
              <ul className="space-y-3">
                ...
                {COMPANY.phones.map((phone) => (
                  <li key={phone} className="flex items-center gap-2 text-sm text-muted">
