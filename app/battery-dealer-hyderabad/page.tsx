...
export const metadata: Metadata = generatePageMetadata({
  ...
  keywords: [
    "top industrial battery dealer Telangana",
    "Exide authorized dealer near me Hyderabad",
    "who is the best Exide dealer Hyderabad",
    "forklift battery dealer Kukatpally",
    "battery dealer Miyapur",
    "industrial battery Gachibowli",
    "forklift battery dealer HITEC City",
    "battery dealer Patancheru",
    "battery dealer Jeedimetla",
    "battery dealer Nacharam",
    "forklift battery IDA Bollaram",
    "battery dealer Pashamylaram",
    "battery dealer Sangareddy",
    "battery dealer Medchal",
    "Exide vs Amara Raja forklift battery",
    "best battery for warehouse forklift",
    "how much does forklift battery cost India",
    "authorized Exide dealer Telangana",
    "forklift battery EMI Hyderabad",
    "bulk battery order Hyderabad",
    "cheapest forklift battery dealer Hyderabad",
    "buy forklift battery cheap Hyderabad",
    "Exide authorized dealer price Hyderabad",
    "forklift battery dealer discount",
    "affordable forklift battery Telangana",
    "Exide battery rate list Hyderabad",
    "forklift battery wholesale price Hyderabad",
    "battery dealer best offers Telangana",
    "Exide factory price battery Hyderabad",
  ],
});
