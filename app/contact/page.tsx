...
export const metadata: Metadata = generatePageMetadata({
  ...
  description:
    "Contact Nektra Energy Solutions for Exide industrial battery enquiries, service booking, and quotes. Chandanagar, Serilingampally, Hyderabad. Call +91 9187615904. Free consultation.",
  path: "/contact",
  keywords: [
