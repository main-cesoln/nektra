...
export const metadata: Metadata = generatePageMetadata({
  ...
  path: "/products",
  keywords: [
    "Exide industrial battery range",
    "forklift battery catalogue Hyderabad",
    "IPzS traction battery",
    "IPzB forklift battery",
    "CEIL gel battery India",
    "DIN standard battery dealer",
    "BS standard battery Hyderabad",
    "BCI forklift battery India",
    "tubular battery for forklift",
    "motive power battery Hyderabad",
    "flooded tubular battery price",
    "gel battery for forklift",
    "HSP Classic battery",
    "forklift battery for Jungheinrich",
    "Toyota forklift battery",
    "Godrej forklift battery",
    "Crown Hyster Yale battery India",
    "reach truck battery",
    "pallet truck battery",
    "AGV battery India",
    "electric forklift battery",
    "Exide battery best price Hyderabad",
    "forklift battery lowest price",
    "industrial battery dealer price",
    "cheap forklift battery India",
    "buy Exide battery online",
    "forklift battery sale offer",
    "traction battery wholesale price",
  ],
});
